...
public class Building : MonoBehaviour
{
	...
	{
		if ( buildingData.building_Level == 0 )
		{
			return;
		}
	...
	public void CheckTerraMineSpawn()
	{
		...
		if ( buildingData.building_OwnedTroops[ troopIndex ].troops_Owned <= 0 )
		{
			return;
		}
		...
		if ( buildingData.building_OwnedTroops[ troopIndex ].troop_Prefab == null )
		{
			return;
		}
	...
	public void CheckMegatronSpawn()
	{
		...
		while ( index > 0 )
		{
			if ( buildingData.building_OwnedTroops[ index ].troops_Owned > 0 )
			{
				break;
			}
		}
	...
	public void CheckBoboSpawn()
	{
		...
		if ( buildingData.building_OwnedTroops[ 0 ].troop_Prefab == null )
		{
			return;
		}
	...
	public double GetDarkElixirPerTick()
	{
		...
		{
			return buildingSO.building_DarkElixirPerSecond * Math.Pow( buildingSO.building_DarkElixirBoostPerLevel, buildingData.building_Level - 1 );
		}
	}
