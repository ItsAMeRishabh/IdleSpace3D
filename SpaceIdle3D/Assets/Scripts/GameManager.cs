...
public class GameManager : MonoBehaviour
{
	...
	[ Header( "Tick Rate" ) ] public static int ticksPerSecond = 30;

	[ Header( "Player Data" ) ] public PlayerData playerData;


	[ Header( "Balancing" ) ] private double upgradeClick_BaseCost = 1000;
	private double upgradeClick_PriceMultiplier = 1.2;
	[ HideInInspector ] public double upgradeClick_CurrentCost = 1000;

	[ Header( "Default Values SO" ) ] [ SerializeField ]
	private DefaultValues defaultValues;

	[ Header( "Iridium Truck" ) ] [ SerializeField ]
	private Transform truckRouteParent;
	...
	public EnemyShipManager EnemyShipManagerRef
	{
		get { return enemyShipManager; }
	}
	...
	public LoadSaveSystem LoadSaveSystemRef
	{
		get { return loadSaveSystem; }
	}
	...
	public StockManager StockManagerRef
	{
		get { return stockManager; }
	}

	public BoostManager BoostManagerRef
	{
		get { return boostManager; }
	}
