...
{
	[ Header( "Always On UI" ) ] [ SerializeField ]
	private GameObject alwaysOnUI;
	...
	[ Header( "Building UI" ) ] [ SerializeField ]
	...
	[ Header( "Stocks Buy UI" ) ] [ SerializeField ]
	private GameObject stockBuyUI;
	...
	[ Header( "Stock Sell UI" ) ] [ SerializeField ]
	private GameObject stockSellUI;
	...
	[ Header( "Profile Selection UI" ) ] [ SerializeField ]
	private GameObject profileSelectionUI;
	...
	[ Header( "Profile Creation UI" ) ] [ SerializeField ]
	private GameObject profileCreationUI;

	[ SerializeField ] private Button button_CreateProfile;
	[ SerializeField ] private TMP_InputField inputField_ProfileName;

	[ Header( "AFK Report UI" ) ] [ SerializeField ]
	private GameObject afkReportUI;
...
#region Building UI
	...
	public void PopulateBuildingUI()
	{
		...
		if ( gameManager.BuildingManagerRef.selectedBuilding != null )
		{
			...
			{
				if ( gameManager.BuildingManagerRef.selectedBuilding.buildingData.building_Level >= populatingBuildingSO.levelUpUnlocks[ i ].level )
				{
					continue;
				}
...
#region Profile Select UI
	...
	{
		if ( !profileSelectionUI.activeSelf )
		{
			return;
		}
...
#region Profile Create UI
	...
	{
		if ( !profileCreationUI.activeSelf )
		{
			return;
		}
